...
void publishData()
{
    ...
    mag_msg.header.frame_id = micro_ros_string_utilities_set(mag_msg.header.frame_id, "imu_link");
    mag_msg.header.stamp.sec = time_stamp.tv_sec;
    mag_msg.header.stamp.nanosec = time_stamp.tv_nsec;

    mag_msg.magnetic_field.x = mag_event.magnetic.x;
    mag_msg.magnetic_field.y = mag_event.magnetic.y;
    mag_msg.magnetic_field.z = mag_event.magnetic.z;

    mag_msg.magnetic_field_covariance[0] = mag_cov_;
    mag_msg.magnetic_field_covariance[4] = mag_cov_;
    mag_msg.magnetic_field_covariance[8] = mag_cov_;  
